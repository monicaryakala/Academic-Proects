...
<form class="login-form" action="FirstEdit" method="post">

    <a href class="form-close bounce">
    <!--<i class="fa fa-times fa-lg"></i>--></a>
   <h3>Update Profile</h3>
    <label for="name">Name:</label>
    <input type="text" id="name" name="Candidate_username" required/>
    <label for="password">Password:</label>
     <input type="password" id="name" name="Candidate_password" required/>
    <label for="password">Candidate Name</label>
    <input type="text" id="electionid" name="Candidate_name" required/>
	 <label for="password">Candidate Email</label>
    <input type="text" id="electionid" name="Candidate_email" required/>
