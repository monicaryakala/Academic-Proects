...
<form class="login-form" action="VideoPost" method="post">

    <a href class="form-close bounce">
    <!--<i class="fa fa-times fa-lg"></i>--></a>
   <h3>Insert Video Link</h3>
...
ArrayList<String> video = (ArrayList<String>) session.getAttribute("videoitem");
for (int i=0;i<video.size();i++) {
%>
<br><br><br>
<iframe width="200" height="150" src="<%= video.get(i) %>" frameborder="0" allowfullscreen></iframe>
<br><br><br>
<% } %>
