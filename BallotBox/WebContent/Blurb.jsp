...
<form class="login-form" action="BlurbPost" method="post">
...
<br><br><br>
<%
ArrayList<modelBlurb> blurb = (ArrayList<modelBlurb>) session.getAttribute("blurbitem");

for(int i=0;i<blurb.size();i++) {

String ID = blurb.get(i).getId();
String Username = blurb.get(i).getUsername();
String title = blurb.get(i).getTitle();
String text = blurb.get(i).getText();
String date = blurb.get(i).getDate();

%>

<h1><%= title %></h1> 
<p><%= Username %><br><%= date %></p>
<h4><%= text %></h4>
