...
String candidates = request.getParameter("candidatename");
String electionid = request.getParameter("electionid");

System.out.println(candidates);

ArrayList<String> video = gd.getVideo(electionid+"_video", candidates);
for (int i=0;i<video.size();i++) {
	System.out.println(video.get(i));
%>
<center>
<br><br><br>
<iframe width="300" height="250" src="<%= video.get(i) %>" frameborder="0" allowfullscreen></iframe>
<br><br><br>
</center>
<% } %>
