...
<title>Ballot Box Voter Survey</title>
...
<header id="masthead" class="site-header" role="banner">
	...
	<div class="row">
		...
		<div class="site-branding">
			...
			<h3><a href="home.html">Ballot Box</a></h3>
...
<form class="login-form">
    <a href class="form-close bounce">
    <!--<i class="fa fa-times fa-lg"></i>--></a>
   <h3>Survey</h3>
   
   
   <p>How do you identify yourself&#63;</p>
<p><input type="radio" name="party" value="conservative"> Conservative</p>
<p><input type="radio" name="party" value="liberal"> Liberal</p>
<p><input type="radio" name="party" value="moderate"> Moderate</p>
<p><input type="radio" name="party" value="progressive"> Progressive</p>

<p>How do you identify yourself socio&#45;economically&#63;</p>
<p><input type="radio" name="class" value="working"> Working Class</p>
<p><input type="radio" name="class" value="middle"> Middle Class</p>
<p><input type="radio" name="class" value="upper"> Upper Class</p>

<p>What is your education level&#63;</p>
<p><input type="radio" name="education" value="none"> Did not complete High School</p>
<p><input type="radio" name="education" value="highschool"> High School Diploma</p>
<p><input type="radio" name="education" value="bachelor"> Bachelor Degree</p>
<p><input type="radio" name="education" value="graduate"> Master Degree</p>

<p>What is your Marital Status&#63;</p>
<p><input type="radio" name="marital" value="single"> single</p>
<p><input type="radio" name="marital" value="married"> Married</p>
<p><input type="radio" name="marital" value="headofhousehold"> Head of Household</p>

<p>What is your Geographic location&#63;</p>
<p><input type="radio" name="geo" value="local"> Born and raised locally</p>
<p><input type="radio" name="geo" value="newyork"> Born within New York</p>
<p><input type="radio" name="geo" value="us"> Born in the US</p>
<p><input type="radio" name="geo" value="foreign"> Born outside the US</p>
...
String partyoption = request.getParameter("party");
String classoption = request.getParameter("class");
String educationoption = request.getParameter("education");
String maritaloption = request.getParameter("marital");
String geooption = request.getParameter("geo");
if(partyoption !=(null))
{ 
try{
	String sql = "INSERT INTO Voter_Survey(question1, question2, question3, question4, question5) VALUES(?,?,?,?,?)";
	ps= con.prepareStatement(sql);
	ps.setString(1, partyoption);
	ps.setString(2, classoption);
	ps.setString(3, educationoption);
	ps.setString(4, maritaloption);
	ps.setString(5, geooption);
	int i = ps.executeUpdate();
	if(i != 0)
	{
		out.println("Successfully inserted survey Answers");
	}
	else
		out.println("Error inserting survey Answers");
	}
