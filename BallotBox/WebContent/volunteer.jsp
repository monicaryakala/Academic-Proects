...
<title>Volunteer - Ballot Box</title>

<!-- This site is optimized with the Yoast SEO plugin v3.1.1 - https://yoast.com/wordpress/plugins/seo/ -->
<link rel="canonical" href="http://demo.rescuethemes.com/politics-plus/volunteer/" />
<meta property="og:locale" content="en_US" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Volunteer - Politics Plus" />
<meta property="og:description" content="&nbsp; We love our volunteers! They make this campaign stronger and we appreciate everything that they do. Whether you can commit to just a few hours a week or more, we&#8217;d like to hear from you! Have a look at the available positions below and days with openings. Then send us a message from the &hellip;" />
<meta property="og:url" content="http://demo.rescuethemes.com/politics-plus/volunteer/" />
<meta property="og:site_name" content="Politics Plus" />
<meta name="twitter:card" content="summary" />
<meta name="twitter:description" content="&nbsp; We love our volunteers! They make this campaign stronger and we appreciate everything that they do. Whether you can commit to just a few hours a week or more, we&#8217;d like to hear from you! Have a look at the available positions below and days with openings. Then send us a message from the [&hellip;]" />
<meta name="twitter:title" content="Volunteer - Politics Plus" />
<!-- / Yoast SEO plugin. -->
...
<link rel='shortlink' href='http://demo.rescuethemes.com/politics-plus/?p=288' />
<link rel="alternate" type="application/json+oembed" href="http://demo.rescuethemes.com/politics-plus/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fdemo.rescuethemes.com%2Fpolitics-plus%2Fvolunteer%2F" />
<link rel="alternate" type="text/xml+oembed" href="http://demo.rescuethemes.com/politics-plus/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fdemo.rescuethemes.com%2Fpolitics-plus%2Fvolunteer%2F&#038;format=xml" />
...
<body class="page page-id-288 page-template-default give-donation-history give-page give-test-mode">
...
<nav id="site-navigation" role="navigation" aria-label="Primary Menu">
        ...
        <li id="menu-item-25" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-5 current_page_item menu-item-25"><a href="home.jsp">Home</a></li>
<li id="menu-item-27" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-27" aria-haspopup="true" aria-expanded="false" tabindex="0"><a href="#">Campaigning</a>
...
<li id="menu-item-290" class="red click-effect menu-item menu-item-type-post_type menu-item-object-page menu-item-290">
<a href="CandidateLogin.jsp">Candidate</a></li>

<li id="menu-item-32" class="blue click-effect menu-item menu-item-type-post_type menu-item-object-page menu-item-32">
<a href="AdminLoin.jsp">Administrator</a>
<ul class="sub-menu" role="menu">
	<li id="menu-item-28" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-28"><a href="volunteer.jsp">Admin Login</a></li>
...
<li id="menu-item-33" class="red click-effect menu-item menu-item-type-post_type menu-item-object-page menu-item-33">
<a href="userlogin1.jsp">Voter</a></li>
...
<article id="post-288" class="post-288 page type-page status-publish hentry">
	...
	<header class="entry-header">
		...
		<!--  <a href="volunteerServlet?action=volunter">Volunteer</a></h1>	</header><!-- .entry-header -->
	...
	<div class="row">
		...
		<div class="large-12 columns">
			...
			<div class="entry-content">
				<h5 style="font-style:italic;"><i style="color:#ef5350" class="fa fa-heart-o fa-2x   pull-left "></i> &nbsp; We love our volunteers!</h5>
<hr class="rescue-spacing " style="height: 20px" />
<p>They make this campaign stronger and we appreciate everything that they do. Whether you can commit to just a few hours a week or more, we&#8217;d like to hear from you!</p>
<p>Have a look at the available positions below and days with openings. Then send us a message from the application tab!</p>
<hr class="rescue-spacing " style="height: 20px" />
<!-- <div id="rescue-tab-89" class="rescue-tabs"><ul class="ui-tabs-nav rescue-clearfix"><li><a href="#rescue-tab-apply-now">Apply Now!</a></li>
<!--<li><a href="#rescue-tab-when-we-need-you">When We Need You</a></li><li><a href="#rescue-tab-position-descriptions">Position Descriptions</a></li></ul>-->
<!--  <div id="rescue-tab-apply-now" class="tab-content  rescue-all"><p>
<div id='contact-form-288'>-->

<form action='volunteerServlet' method='post' class='contact-form commentsblock'>
<input type="hidden" name="action" value="volunter">
<div>
		<label for='g288-name' class='grunion-field-label name'>ElectionID<span>(required)</span></label>
		<input type='text' name='ElectionID' id='ElectionID' value='' class='name'  required aria-required='true'/>
	</div>
<div>
		<label for='g288-name' class='grunion-field-label name'>Name<span>(required)</span></label>
		<input type='text' name='name' id='g288-name' value='' class='name'  required aria-required='true'/>
	</div>

<div>
		<label for='g288-email' class='grunion-field-label email'>Email<span>(required)</span></label>
		<input type='email' name='email' id='g288-email' value='' class='email'  required aria-required='true'/>
	</div>

<div>
		<label for='g288-phonenumber' class='grunion-field-label text'>Phone Number</label>
		<input type='text' name='phonenumber' id='g288-phonenumber' value='' class='text'  />
	</div>

<div>
		<label for='contact-form-comment-g288-additionalcomments' class='grunion-field-label textarea'>Additional Comments<span>(required)</span></label>
		<textarea name='comments' id='contact-form-comment-g288-additionalcomments' rows='20' class='textarea'  required aria-required='true'></textarea>
	</div>
	
	<p class='contact-submit'>
		<input type='submit' value='Submit' class='pushbutton-wide'/>
		<input type='hidden' name='contact-form-id' value='288' />

	</p>
</form>
</div>
</p></div>
<!--<div id="rescue-tab-when-we-need-you" class="tab-content  rescue-all"><p>
<table>
<thead>
<tr>
<th>Day</th>
...
<th>Monday</th>
<td>Afternoon</td>
<td>Assistants, Donation Collectors</td>
</tr>
<tr>
<th>Wednesday</th>
<td>Evening</td>
<td>Call-Center Operator, Donation Collectors</td>
</tr>
<tr>
<th>Friday</th>
<td>Morning</td>
<td>Donation Collectors</td>
</tr>
</tbody>
</table>
</p></div>
<div id="rescue-tab-position-descriptions" class="tab-content  rescue-all"><p>
<p><strong>Personal Assistant:</strong> Hic mi! Reprehenderit natus? Libero, nihil? Occaecati! Adipisci sint optio, suspendisse nam? Natoque lacinia soluta, dis mattis deleniti sapiente leo perspiciatis quasi.</p>
<p><strong>Call-Center Operator:</strong> Urna illum repudiandae? Magna rhoncus enim repudiandae ipsam eleifend bibendum vehicula lacinia autem dictumst cursus placerat distinctio explicabo dolorem ad eius.</p>
<p><strong>Donation Collector:</strong> Nobis pede massa quia, quas, reprehenderit. Quidem tempora placeat, ea deserunt consequatur? Vel primis, voluptate eget? Ultrices nisl blanditiis augue inventore.</p>
</p></div>
</div>
							</div><!-- .entry-content -->
...
<script type='text/javascript'>
/* <![CDATA[ */
var wc_add_to_cart_params = {"ajax_url":"\/politics-plus\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/politics-plus\/volunteer\/?wc-ajax=%%endpoint%%","i18n_view_cart":"View Cart","cart_url":"http:\/\/demo.rescuethemes.com\/politics-plus\/cart\/","is_cart":"","cart_redirect_after_add":"no"};
/* ]]> */
</script>
...
<script type='text/javascript'>
/* <![CDATA[ */
var woocommerce_params = {"ajax_url":"\/politics-plus\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/politics-plus\/volunteer\/?wc-ajax=%%endpoint%%"};
/* ]]> */
</script>
...
<script type='text/javascript'>
/* <![CDATA[ */
var wc_cart_fragments_params = {"ajax_url":"\/politics-plus\/wp-admin\/admin-ajax.php","wc_ajax_url":"\/politics-plus\/volunteer\/?wc-ajax=%%endpoint%%","fragment_name":"wc_fragments"};
/* ]]> */
</script>
...
<script type='text/javascript' src='http://8317-presscdn-0-96.pagely.netdna-cdn.com/politics-plus/wp-includes/js/jquery/ui/core.min.js?ver=1.11.4'></script>
<script type='text/javascript' src='http://8317-presscdn-0-96.pagely.netdna-cdn.com/politics-plus/wp-includes/js/jquery/ui/widget.min.js?ver=1.11.4'></script>
<script type='text/javascript' src='http://8317-presscdn-0-96.pagely.netdna-cdn.com/politics-plus/wp-includes/js/jquery/ui/tabs.min.js?ver=1.11.4'></script>
<script type='text/javascript' src='http://8317-presscdn-0-96.pagely.netdna-cdn.com/politics-plus/wp-content/plugins/rescue-shortcodes/includes/js/rescue_tabs.js?ver=1.0'></script>
<script type='text/javascript' src='http://8317-presscdn-0-96.pagely.netdna-cdn.com/politics-plus/wp-content/plugins/jetpack/modules/widgets/gallery/js/gallery.js?ver=4.4.2'></script>
<script type='text/javascript' src='http://8317-presscdn-0-96.pagely.netdna-cdn.com/politics-plus/wp-content/plugins/jetpack/_inc/spin.js?ver=1.3'></script>
<script type='text/javascript' src='http://8317-presscdn-0-96.pagely.netdna-cdn.com/politics-plus/wp-content/plugins/jetpack/_inc/jquery.spin.js?ver=1.3'></script>
<script type='text/javascript'>
/* <![CDATA[ */
var jetpackCarouselStrings = {"widths":[370,700,1000,1200,1400,2000],"is_logged_in":"","lang":"en","ajaxurl":"http:\/\/demo.rescuethemes.com\/politics-plus\/wp-admin\/admin-ajax.php","nonce":"831c8be7f7","display_exif":"1","display_geo":"1","background_color":"black","comment":"Comment","post_comment":"Post Comment","write_comment":"Write a Comment...","loading_comments":"Loading Comments...","download_original":"View full size <span class=\"photo-size\">{0}<span class=\"photo-size-times\">\u00d7<\/span>{1}<\/span>","no_comment_text":"Please be sure to submit some text with your comment.","no_comment_email":"Please provide an email address to comment.","no_comment_author":"Please provide your name to comment.","comment_post_error":"Sorry, but there was an error posting your comment. Please try again later.","comment_approved":"Your comment was approved.","comment_unapproved":"Your comment is in moderation.","camera":"Camera","aperture":"Aperture","shutter_speed":"Shutter Speed","focal_length":"Focal Length","comment_registration":"0","require_name_email":"1","login_url":"http:\/\/demo.rescuethemes.com\/politics-plus\/wp-login.php?redirect_to=http%3A%2F%2Fdemo.rescuethemes.com%2Fpolitics-plus%2Fvolunteer%2F","local_comments_commenting_as":"<fieldset><label for=\"email\">Email (Required)<\/label> <input type=\"text\" name=\"email\" class=\"jp-carousel-comment-form-field jp-carousel-comment-form-text-field\" id=\"jp-carousel-comment-form-email-field\" \/><\/fieldset><fieldset><label for=\"author\">Name (Required)<\/label> <input type=\"text\" name=\"author\" class=\"jp-carousel-comment-form-field jp-carousel-comment-form-text-field\" id=\"jp-carousel-comment-form-author-field\" \/><\/fieldset><fieldset><label for=\"url\">Website<\/label> <input type=\"text\" name=\"url\" class=\"jp-carousel-comment-form-field jp-carousel-comment-form-text-field\" id=\"jp-carousel-comment-form-url-field\" \/><\/fieldset>"};
/* ]]> */
</script>
<script type='text/javascript' src='http://8317-presscdn-0-96.pagely.netdna-cdn.com/politics-plus/wp-content/plugins/jetpack/modules/carousel/jetpack-carousel.js?ver=20140505'></script>
<script type='text/javascript' src='http://8317-presscdn-0-96.pagely.netdna-cdn.com/politics-plus/wp-content/plugins/jetpack/modules/tiled-gallery/tiled-gallery/tiled-gallery.js?ver=4.4.2'></script>
...
<script type='text/javascript'>
	_stq = window._stq || [];
	_stq.push([ 'view', {v:'ext',j:'1:3.9.2',blog:'98811088',post:'288',tz:'0',srv:'demo.rescuethemes.com'} ]);
	_stq.push([ 'clickTrackerInit', '98811088', '288' ]);
</script>
