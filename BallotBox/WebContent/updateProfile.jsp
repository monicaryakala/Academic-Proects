...
<a href="adminlogin.html">Adminstrator</a></li>
<li id="menu-item-182" class="blue click-effect menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-182" aria-haspopup="true" aria-expanded="false" tabindex="0"><a href="campaigning2.html">Campaigning</a>
<ul class="sub-menu" role="menu">
	<li id="menu-item-181" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-181"><a href="volunteer.html">volunteer</a></li>
	<li id="menu-item-180" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-180"><a href="donate.html">Donate</a></li>
...
<li id="menu-item-26" class="blue click-effect menu-item menu-item-type-post_type menu-item-object-page menu-item-26"><a href="voterslogin.html">Voter</a></li>
...
<form class="login-form" action="UpdateProfile" method="post">
   ...
   <h3>Update Profile</h3>
    ...
    <input type="text" id="name" name="Candidate_username" />
    <label for="password">Password:</label>
     <input type="password" id="name" name="Candidate_password"/>
    <label for="password">Candidate Name</label>
    <input type="text" id="electionid" name="Candidate_name"/>
	 <label for="password">Candidate Email</label>
    <input type="text" id="electionid" name="Candidate_email"/>
    <label for="password">WebPage</label>
    <input type="text" id="WebPage" name="WebPage" required/>
	<input type="hidden" name="login_type" id="login_type" value='1' required>
