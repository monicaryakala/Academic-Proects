...
ArrayList<String> candidates  = (ArrayList<String>) request.getAttribute("candidates");

for(int i=0;i<candidates.size();i++) {
%>

<h1><%= candidates.get(i) %></h1><br>
<form action="showBlurb.jsp">
<input type="hidden" value="<%= electionid %>" name="electionid">
<input type="hidden" value="<%= candidates.get(i) %>" name="candidatename">
 <button type="submit">Blog</button>
</form>

<form action="showVideo.jsp">
<input type="hidden" value="<%= electionid %>" name="electionid">
<input type="hidden" value="<%= candidates.get(i) %>" name="candidatename">
