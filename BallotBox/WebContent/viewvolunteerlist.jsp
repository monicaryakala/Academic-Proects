...
<title>Get In Touch! - Ballot Box</title>
...
<li><a href="volunteerServlet?action=viewvolunteerlist"><h4>View VolunteerList</h4></a></li>
<%ArrayList<String[]> a = (ArrayList<String[]>) request.getAttribute("volunteerlist");
if(a!=null){
%>
<table>
<tr>
